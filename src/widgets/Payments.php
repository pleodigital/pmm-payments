...
namespace pleodigital\pmmpayments\widgets;

use pleodigital\pmmpayments\Pmmpayments;
use pleodigital\pmmpayments\assetbundles\paymentswidget\PaymentsWidgetAsset;
...
class Payments extends Widget
{
    ...
    {
        return Craft::t('pmm-payments', 'Payments');
    }
    ...
    {
        return Craft::getAlias("@pleodigital/pmmpayments/assetbundles/paymentswidget/dist/img/Payments-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'pmm-payments/_components/widgets/Payments_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(PaymentsWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'pmm-payments/_components/widgets/Payments_body',
            [
